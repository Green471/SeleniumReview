public class Day03_Notlar {
    ...
    ***** 3 FARKLI SEÇİM YAPMA YÖNTEMİ
    ...
    ---------------------------ASSERTIONS----------------------------
    Maven ile test yaptığınız projelerde, if-else ile doğrulama yaparak sadece kendinizi ve o projeyi izleyenleri_
     bilgilendirirsiniz.
    Fakat test çalıştırma ortalamınızı(mesela intellij) junit, testng, cucumber gibi kütüphanelerden gelen Assert_
     işlemini uygulamanız gerekir. Aksi durumda, yani Assert işlemi yapmazsanız tüm testleriniz başarılı görünür.
